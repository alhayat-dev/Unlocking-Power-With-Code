    ...
    <div class="container">
        ...
        <div class="site-header__menu group">
            <nav class="main-navigation">
                <ul>
                    <li <?php if (is_page('about-us') or wp_get_post_parent_id(0) == 5) echo 'class="current-menu-item"'?>>
                    ...
                    <li <?php if (get_post_type() == 'campus' OR is_page('past-events')) echo 'class="current-menu-item"'?>>
