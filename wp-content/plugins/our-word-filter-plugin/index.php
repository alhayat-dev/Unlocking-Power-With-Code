...
/*
  ...
  Version 1.0
  Author: Mudasser
  Author URI: https://www.udemy.com/user/mudasser/
*/
        ...
        <div class="wrap">
            ...
            <form method="POST">
                ...
                <div class="word-filter__flex-container">
                    <textarea name="plugin_words_to_filter" id="plugin_words_to_filter" placeholder="bad, mean, awful, horrible"><?php echo esc_textarea(trim(get_option('plugin_words_to_filter'))); ?></textarea>
                </div>
